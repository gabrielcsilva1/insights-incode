...
export function InsightCard({ label, date, $bgColor, onDelete, onUpdate }: InsightCardProps) {
    ...
    return (
        <Dialog.Root onOpenChange={(isOpen) => isOpen ? '' : setModalInsigth(label)}>
            ...
            <Dialog.Portal>
                ...
                <InsightsDate>{date}</InsightsDate>
                    ...
                    <button className="edit-btn" type="button" onClick={() => { onUpdate(label, modalInsigth)}}>
